...
def hello():
    """function displaying Hello HBNB!"""
    return "Hello HBNB!"


@app.route('/hbnb', strict_slashes=False)
def display():
    """function displaying HBNB"""
    return "HBNB"


@app.route('/c/<text>', strict_slashes=False)
def cText(text):
    """function to display C followed by value of text"""
...
def numEvenOdd(n):
    """function to display a HTML page ony if n is integer"""
    if isinstance(n, int):
